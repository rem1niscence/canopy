  ...
  [196],
  {
    3148: function (t, e, i) {
       ...
       */ class a {
        ...
        _update(t = Date.now()) {
          ...
          this._charts.forEach((i, s) => {
            ...
            for (; r >= 0; --r)
              (a = n[r])._active
                ? (a._total > i.duration && (i.duration = a._total), a.tick(t), (o = !0))
        ...
        _getAnims(t) {
          ...
          return (
            i ||
              ((i = { running: !1, initial: !0, items: [], listeners: { complete: [], progress: [] } }), e.set(t, i)),
            i
          );
        }
        listen(t, e, i) {
        ...
        _animateOptions(t, e) {
          let i = e.options,
            s = (function (t, e) {
              ...
              return i.$shared && (t.options = i = Object.assign({}, i, { $shared: !1, $animations: {} })), i;
            })(t, i);
          if (!s) return [];
      ...
      let b = (t) => "reset" === t || "none" === t,
        ...
        v = (t, e, i) => t && !e.hidden && e._stacked && { keys: c(i, !0), values: null };
      class y {
        static defaults = {};
          ...
          if ((0, s.i)(e)) {
            ...
            this._data = (function (t, e) {
              ...
              let { iScale: n, vScale: r } = e,
                ...
                h = Object.keys(t),
                d = Array(h.length);
              for (i = 0, s = h.length; i < s; ++i) (a = h[i]), (d[i] = { [o]: a, [l]: t[a] });
              return d;
            })(e, t);
          } else if (i !== e) {
            if (i) {
        ...
        buildOrUpdateElements(t) {
          ...
          (e._stacked = g(e.vScale, e)),
            ...
            (s || a !== e._stacked) && (f(this, e._parsed), (e._stacked = g(e.vScale, e)));
        }
        configure() {
        ...
        parsePrimitiveData(t, e, i, s) {
          ...
          let { iScale: r, vScale: o } = t,
            ...
            c = r === o,
            u = Array(s);
          for (a = 0; a < s; ++a) (n = a + i), (u[a] = { [l]: c || r.parse(d[n], n), [h]: o.parse(e[n], n) });
          return u;
        }
        parseArrayData(t, e, i, s) {
          ...
          let { xScale: o, yScale: l } = t,
            h = Array(s);
          for (a = 0; a < s; ++a) (r = e[(n = a + i)]), (h[a] = { x: o.parse(r[0], n), y: l.parse(r[1], n) });
          return h;
        }
        parseObjectData(t, e, i, a) {
          ...
          let { xScale: l, yScale: h } = t,
            ...
            u = Array(a);
          for (n = 0; n < a; ++n)
            (o = e[(r = n + i)]), (u[n] = { x: l.parse((0, s.f)(o, d), r), y: h.parse((0, s.f)(o, c), r) });
          return u;
        }
        getParsed(t) {
        ...
        applyStack(t, e, i) {
          let s = this.chart,
            a = this._cachedMeta,
            n = e[t.axis];
          return u({ keys: c(s, !0), values: e._stacks[t.axis]._visualValues }, n, a.index, { mode: i });
        }
        ...
        _update(t) {
          ...
          this.update(t || "default"),
            (o._clip =
              ...
              (0, s.i)(e) ? ((i = e.top), (a = e.right), (n = e.bottom), (r = e.left)) : (i = a = n = r = e),
          ...
          (0, s.b)(t)
            ? (function (t, e, i, s) {
                ...
                Math.abs(r) > Math.abs(o) && ((l = o), (h = r)),
                  (e[i.axis] = h),
                  (e._custom = { barStart: l, barEnd: h, start: a, end: n, min: r, max: o });
              })(t, e, i, a)
      ...
      function k(t, e, i, s) {
        ...
        let l = t.iScale,
          ...
          u = [];
        for (a = i, n = i + s; a < n; ++a)
          (o = e[a]), ((r = {})[l.axis] = c || l.parse(d[a], a)), u.push(M(o, r, h, a));
        return u;
      }
      function w(t) {
      ...
      class P extends y {
        ...
        parseObjectData(t, e, i, a) {
          ...
          let { iScale: h, vScale: d } = t,
            ...
            f = [];
          for (n = i, r = i + a; n < r; ++n)
            (l = e[n]), ((o = {})[h.axis] = h.parse((0, s.f)(l, g), n)), f.push(M((0, s.f)(l, p), o, d, n));
          return f;
        }
        updateRangeFromParsed(t, e, i, s) {
        ...
        getLabelAndValue(t) {
          let { iScale: e, vScale: i } = this._cachedMeta,
            s = this.getParsed(t),
            a = s._custom,
            n = w(a) ? "[" + a.start + ", " + a.end + "]" : "" + i.getLabelForValue(s[i.axis]);
        ...
        updateElements(t, e, i, a) {
          ...
          for (let g = e; g < e + i; g++) {
            let e = this.getParsed(g),
              i = n || (0, s.k)(e[o.axis]) ? { base: l, head: l } : this._calculateBarValuePixels(g),
              p = this._calculateBarIndexPixels(g, d),
              f = (e._stacks || {})[o.axis],
              m = {
                horizontal: h,
                base: i.base,
                enableBorderRadius: !f || w(e._custom) || r === f._top || r === f._bottom,
                x: h ? i.head : p.center,
                y: h ? p.center : i.head,
            ...
            !(function (t, e, i, s) {
              ...
              "middle" === h &&
                ...
                (i._top || 0) === s ? (h = p) : (i._bottom || 0) === s ? (h = f) : ((d[S(f, c, u, g)] = !0), (h = p))),
                (d[S(h, c, u, g)] = !0),
                (t.borderSkipped = d);
            })(m, x, f, r),
        ...
        _getStacks(t, e) {
          ...
          for (let i of a)
            if (
              !(void 0 !== e && h(i)) &&
              ((!1 === n || -1 === r.indexOf(i.stack) || (void 0 === n && void 0 === i.stack)) && r.push(i.stack),
              i.index === t)
            )
              break;
        ...
        _calculateBarValuePixels(t) {
          ...
          if (Math.abs((i = (e = this.chart.getDataVisibility(t) ? a.getPixelForValue(p + f) : x) - x)) < l) {
            var b;
            (i = (0 !== (b = i) ? (0, s.s)(b) : (a.isHorizontal() ? 1 : -1) * (a.min >= h ? 1 : -1)) * l),
              g === h && (x -= i / 2);
              ...
              h =
                "flex" === r.barThickness
                  ? (function (t, e, i, s) {
                      ...
                      return { chunk: ((Math.abs(o - r) / 2) * l) / s, ratio: i.barPercentage, start: h };
                    })(t, e, r, n)
                  : (function (t, e, i, a) {
                      let n, r;
                      let o = i.barThickness;
      ...
      class C extends y {
        ...
        getLabelAndValue(t) {
          let e = this._cachedMeta,
            ...
            l = n._custom;
          return { label: i[t] || "", value: "(" + r + ", " + o + (l ? ", " + l : "") + ")" };
        }
        update(t) {
        ...
        updateElements(t, e, i, s) {
          ...
          for (let c = e; c < e + i; c++) {
            ...
            (u.skip = isNaN(g) || isNaN(p)),
              l &&
                ((u.options = o || this.resolveDataElementOptions(c, e.active ? "active" : s)),
        ...
        updateElements(t, e, i, a) {
          ...
          for (let i = 0; i < _; ++i) {
            ...
            let y = this.getParsed(i),
              ...
              w = (_[g] = n || M ? o.getBasePixel() : o.getPixelForValue(l ? this.applyStack(o, y, l) : y[g], i));
        ...
        updateElements(t, e, i, s) {
          ...
          for (let r = e; r < e + i; r++) {
            let e = t[r],
              ...
              l = n ? a.xCenter : o.x,
              h = n ? a.yCenter : o.y,
              d = { x: l, y: h, angle: o.angle, skip: isNaN(l) || isNaN(h), options: i };
      ...
      class F extends y {
        ...
        update(t) {
          ...
          if (
            ...
            (r.segment = this.options.segment), this.updateElement(s, void 0, { animated: !a, options: r }, t);
          ...
          ? "r" !== i || a
            ? (function (t, e, i, s, a, n) {
                let r = [],
                  o = (function (t) {
                    ...
                    return function (t, s) {
                      return Math.sqrt(
                        Math.pow(e ? Math.abs(t.x - s.x) : 0, 2) + Math.pow(i ? Math.abs(t.y - s.y) : 0, 2),
                      );
                    };
                  })(i),
                ...
                return (
                  I(t, i, e, function (i, h, d) {
                    ...
                    let g = o(e, u);
                    g < l
                      ? ((r = [{ element: i, datasetIndex: h, index: d }]), (l = g))
                      : g === l && r.push({ element: i, datasetIndex: h, index: d });
                  }),
                  r
                );
              })(t, e, i, a, n, r)
            : ((o = []),
              I(t, i, e, function (t, i, a) {
                ...
                (0, s.p)(h, r, l) && o.push({ element: t, datasetIndex: i, index: a });
              }),
              o)
          : [];
      }
      function B(t, e, i, s, a) {
        let n = [],
        ...
        return (I(t, i, e, (t, s, l) => {
          t[r] &&
            t[r](e[i], a) &&
            (n.push({ element: t, datasetIndex: s, index: l }), (o = o || t.inRange(e.x, e.y, a)));
        }),
        s && !o)
          ? []
          : n;
        ...
        modes: {
          index(t, e, i, a) {
            let n = (0, s.z)(e, t),
              ...
              l = i.intersect ? V(t, n, r, a, o) : N(t, n, r, !1, a, o),
              h = [];
            return l.length
          ...
          dataset(t, e, i, a) {
            ...
            if (l.length > 0) {
              ...
              l = [];
              for (let t = 0; t < i.length; ++t) l.push({ element: i[t], datasetIndex: e, index: t });
            }
            return l;
          },
          point(t, e, i, a) {
          ...
          x(t, e, i, a) {
            let n = (0, s.z)(e, t);
            return B(t, n, "x", i.intersect, a);
          },
          y(t, e, i, a) {
            let n = (0, s.z)(e, t);
            return B(t, n, "y", i.intersect, a);
          },
        },
      };
        ...
        for (n = 0, r = t.length, h = 0; n < r; ++n) {
          ...
          let { same: r, other: u } = (function (t, e, i, a) {
            ...
            let l = Math.max(0, e.outerWidth - Y(o, t, "left", "right")),
              ...
              d = l !== t.w,
              c = h !== t.h;
            return (t.w = l), (t.h = h), i.horizontal ? { same: d, other: c } : { same: c, other: d };
          })(e, i, o, a);
        ...
        for (let l of t) {
          ...
          if (l.horizontal) {
            ...
            (0, s.h)(h.start) && (o = h.start),
              t.fullSize ? q(t, n.left, o, i.outerWidth - n.right - n.left, r) : q(t, e.left + h.placed, o, a, r),
              (h.start = o),
              (h.placed += a),
              (o = t.bottom);
          } else {
            ...
            (0, s.h)(h.start) && (r = h.start),
              t.fullSize ? q(t, r, n.top, o, i.outerHeight - n.bottom - n.top) : q(t, r, e.top + h.placed, o, a),
              (h.start = r),
              (h.placed += a),
              (r = t.right);
          }
      ...
      var K = {
        ...
        update(t, e, i, a) {
          ...
          let c = Object.freeze({
              ...
              availableHeight: o,
              vBoxMaxWidth:
                r / 2 / (h.reduce((t, e) => (e.box.options && !1 === e.box.options.display ? t : t + 1), 0) || 1),
              hBoxMaxHeight: o / 2,
            }),
            u = Object.assign({}, n);
          Q(u, (0, s.E)(a));
          let g = Object.assign({ maxPadding: u, w: r, h: o, x: n.left, y: n.top }, n),
            p = (function (t, e) {
              let i, s, a;
              let n = (function (t) {
                  let e = {};
          ...
          X(l.fullSize, g, c, p),
            ...
            G(l.leftAndTop, g, c, p),
            (g.x += g.w),
            (g.y += g.h),
            G(l.rightAndBottom, g, c, p),
            (t.chartArea = {
              left: g.left,
              top: g.top,
              right: g.left + g.w,
              ...
              i(
                (function (t, e) {
                  let i = te[t.type] || t.type,
                    { x: a, y: n } = (0, s.z)(t, e);
                  return { type: i, chart: e, native: t, x: void 0 !== a ? a : null, y: void 0 !== n ? n : null };
                })(e, t),
              );
          }, t);
      ...
      class tg extends J {
        acquireContext(t, e) {
          ...
          return i && i.canvas === t
            ? (!(function (t, e) {
                ...
                if (
                  ((t[tt] = {
                    initial: { height: a, width: n, style: { display: i.display, height: i.height, width: i.width } },
                  }),
        ...
        addEventListener(t, e, i) {
          ...
          let s = t.$proxies || (t.$proxies = {}),
            a = { attach: tn, detach: tr, resize: td }[e] || tu;
          s[e] = a(t, e, i);
        }
        removeEventListener(t, e) {
          ...
          s &&
            ((
              { attach: tc, detach: tc, resize: tc }[e] ||
              function (t, e, i) {
      ...
      class tM extends tp {
        ...
        getUserBounds() {
          ...
          return (
            ...
            { min: (0, s.O)(t, i), max: (0, s.O)(e, a), minDefined: (0, s.g)(t), maxDefined: (0, s.g)(e) }
          );
        }
        getMinMax(t) {
          let e,
            { min: i, max: a, minDefined: n, maxDefined: r } = this.getUserBounds();
          if (n && r) return { min: i, max: a };
          let o = this.getMatchingVisibleMetas();
          for (let s = 0, l = o.length; s < l; ++s)
            (e = o[s].controller.getMinMax(this, t)), n || (i = Math.min(i, e.min)), r || (a = Math.max(a, e.max));
          return (
            (i = r && i > a ? a : i),
            (a = n && i > a ? i : a),
            { min: (0, s.O)(i, (0, s.O)(a, i)), max: (0, s.O)(a, (0, s.O)(i, a)) }
          );
        }
        getPadding() {
          return {
        ...
        update(t, e, i) {
          ...
          this._convertTicksToLabels(l ? t_(this.ticks, o) : this.ticks),
            this.configure(),
            ...
            r.display &&
              ...
              ((this.ticks = (function (t, e) {
                ...
                if (o > 0) {
                  ...
                  for (tf(e, d, c, (0, s.k)(a) ? 0 : l - a, l), t = 0, i = o - 1; t < i; t++)
                    tf(e, d, c, r[t], r[t + 1]);
        ...
        calculateLabelRotation() {
          ...
          c + 6 > (t = a.offset ? this.maxWidth / r : g / (r - 1)) &&
            ...
            (e = this.maxHeight - tv(a.grid) - n.padding - ty(a.title, this.chart.options.font)),
            (i = Math.sqrt(c * c + u * u)),
            (h = Math.max(
              o,
              Math.min(
                ...
                (h = (0, s.U)(
                  Math.min(
                    ...
                    Math.asin((0, s.S)(e / i, -1, 1)) - Math.asin((0, s.S)(u / i, -1, 1)),
                  ),
                )),
              ),
            ))),
        ...
        fit() {
          ...
          if (r) {
            ...
            if (
              (o
                ? ((t.width = this.maxWidth), (t.height = tv(n) + r))
                : ((t.height = this.maxHeight), (t.width = tv(n) + r)),
        ...
        _calculatePadding(t, e, i, s) {
          ...
          if (this.isHorizontal()) {
            ...
            let i = e.height / 2,
              s = t.height / 2;
            "start" === a ? ((i = 0), (s = t.height)) : "end" === a && ((i = e.height), (s = 0)),
              (this.paddingTop = i + n),
        ...
        _computeLabelSizes(t, e, i) {
            ...
            if (
              ...
              if ((0, s.b)(o))
                for (n = 0, r = o.length; n < r; ++n)
                  (p = o[n]), (0, s.k)(p) || (0, s.b)(p) || ((u = (0, s.V)(f, d.data, d.gc, u, p)), (g += c));
          ...
          return { first: w(0), last: w(e - 1), widest: w(M), highest: w(k), widths: x, heights: b };
        }
        getLabelForValue(t) {
          return t;
        }
        ...
        getContext(t) {
          ...
          if (t >= 0 && t < a.length) {
            let i = a[t];
            return (
              i.$context || (i.$context = ((e = this.getContext()), (0, s.j)(e, { tick: i, index: t, type: "tick" })))
            );
          }
          return (
            this.$context ||
            (this.$context = ((i = this.chart.getContext()), (0, s.j)(i, { scale: this, type: "scale" })))
          );
        }
        _tickSize() {
        ...
        _computeGridLineItems(t) {
          ...
          if ("top" === b) (e = C(this.bottom)), (o = this.bottom - k), (h = e - P), (c = C(t.top) + P), (g = t.bottom);
          else if ("bottom" === b)
            (e = C(this.top)), (c = t.top), (g = C(t.bottom) - P), (o = e + P), (h = this.top + k);
          else if ("left" === b)
            (e = C(this.right)), (r = this.right - k), (l = e - P), (d = C(t.left) + P), (u = t.right);
          else if ("right" === b)
            (e = C(this.left)), (d = t.left), (u = C(t.right) - P), (r = e + P), (l = this.left + k);
          else if ("x" === p) {
            ...
            if (
              (x
                ? ((n = l),
                  ...
                  M && (u *= -1),
                  0 === D || g.showLabelBackdrop || (n += (d / 2) * Math.sin(D)))
                : ((r = l), (u = ((1 - c) * d) / 2)),
              g.showLabelBackdrop)
            ) {
              ...
              t = { left: h, top: l, width: r + a.width, height: n + a.height, color: g.backdropColor };
            }
            P.push({
              label: a,
              font: h,
        ...
        drawGrid(t) {
          ...
          if (s.display)
            for (e = 0, i = n.length; e < i; ++e) {
              let t = n[e];
              s.drawOnChartArea && r({ x: t.x1, y: t.y1 }, { x: t.x2, y: t.y2 }, t),
                s.drawTicks &&
                  r(
                    { x: t.tx1, y: t.ty1 },
                    { x: t.tx2, y: t.ty2 },
        ...
        drawBorder() {
          ...
          let c = l.setContext(this.getContext(0)).lineWidth,
            u = this._borderValue;
          this.isHorizontal()
            ? ((t = (0, s.X)(n, this.left, d) - d / 2), (e = (0, s.X)(n, this.right, c) + c / 2), (i = a = u))
            : ((i = (0, s.X)(n, this.top, d) - d / 2), (a = (0, s.X)(n, this.bottom, c) + c / 2), (t = e = u)),
            r.save(),
            (r.lineWidth = h.width),
        ...
        drawTitle() {
          ...
          "bottom" === i || "center" === i || (0, s.i)(i)
            ? ((h += o.bottom), (0, s.b)(a.text) && (h += r.lineHeight * (a.text.length - 1)))
            : (h += o.top);
          let {
            titleX: d,
            titleY: c,
      ...
      class tw {
        constructor() {
          (this.controllers = new tk(y, "datasets", !0)),
            (this.elements = new tk(tp, "elements")),
            (this.plugins = new tk(Object, "plugins")),
            (this.scales = new tk(tM, "scales")),
                    ...
                    n.push({
                      ...
                      options: (function (t, { plugin: e, local: i }, s, a) {
                        ...
                        return (
                          ...
                          t.createResolver(r, a, [""], { scriptable: !1, indexable: !1, allKeys: !0 })
                        );
            ...
            return (
              Object.keys(a).forEach((e) => {
                ...
                let l = tL(
                  ...
                  d = i.scales || {};
                r[e] = (0, s.ab)(Object.create(null), [{ axis: l }, o, d[l], d[h]]);
              }),
              t.data.datasets.forEach((i) => {
                ...
                Object.keys(l).forEach((t) => {
                  ...
                  let n = ((e = t), "_index_" === t ? (e = o) : "_value_" === t && (e = "x" === o ? "y" : "x"), e),
                    h = i[n + "AxisID"] || n;
                  (r[h] = r[h] || Object.create(null)), (0, s.ab)(r[h], [{ axis: n }, a[h], l[t]]);
                });
              }),
      ...
      class tI {
        ...
        datasetElementScopeKeys(t, e) {
          return tz(`${t}-${e}`, () => [[`datasets.${t}.elements.${e}`, `datasets.${t}`, `elements.${e}`, ""]]);
        }
        pluginScopeKeys(t) {
          let e = t.id,
            i = this.type;
          return tz(`${i}-plugin-${e}`, () => [[`plugins.${e}`, ...(t.additionalOptionScopes || [])]]);
        }
        _cachedScopes(t, e) {
            ...
            (function (t, e) {
              ...
              for (let n of e) {
                let e = i(n),
                  r = a(n),
                  o = (r || e) && t[n];
                if ((e && ((0, s.a7)(o) || tN(o))) || (r && (0, s.b)(o))) return !0;
              }
              return !1;
            })(r, e)
          ) {
      ...
      function tV(t, e, i) {
        ...
        return (
          r ||
            ((r = { resolver: (0, s.a9)(e, i), subPrefixes: i.filter((t) => !t.toLowerCase().includes("hover")) }),
            a.set(n, r)),
          r
        );
      }
      let tN = (t) => (0, s.i)(t) && Object.getOwnPropertyNames(t).some((e) => (0, s.a7)(t[e])),
        tB = ["top", "bottom", "left", "right", "chartArea"];
      function tH(t, e) {
        return "top" === t || "bottom" === t || (-1 === tB.indexOf(t) && "x" === e);
      }
      function tW(t, e) {
        return function (i, s) {
      ...
      function tU(t) {
        return (
          (0, s.M)() && "string" == typeof t ? (t = document.getElementById(t)) : t && t.length && (t = t[0]),
      ...
      class tq {
        ...
        constructor(t, e) {
          ...
          (this.platform = new (i.platform ||
            (!(0, s.M)() || ("undefined" != typeof OffscreenCanvas && a instanceof OffscreenCanvas) ? Z : tg))()),
          ...
          if (
            ...
            (this.$context = void 0),
            (this._doResize = (0, s.ad)((t) => this.update(t), o.resizeDelay || 0)),
            (this._dataChanges = []),
            (tY[this.id] = this),
            !l || !h)
          ) {
          ...
          n.listen(this, "complete", tj),
            n.listen(this, "progress", t$),
            this._initialize(),
        ...
        _initialize() {
          return (
            ...
            this.options.responsive ? this.resize() : (0, s.ae)(this, this.options.devicePixelRatio),
            this.bindEvents(),
        ...
        resize(t, e) {
          n.running(this) ? (this._resizeBeforeDraw = { width: t, height: e }) : this._resize(t, e);
        }
        _resize(t, e) {
          let i = this.options,
            a = this.canvas,
        ...
        buildOrUpdateScales() {
          ...
          e &&
            ...
            (0, s.F)(n, (e) => {
              ...
              (void 0 === n.position || tH(n.position, o) !== tH(e.dposition)) && (n.position = e.dposition),
                (a[r] = !0);
              let h = null;
              r in i && i[r].type === l
                ? (h = i[r])
                : (i[(h = new (tS.getScale(l))({ id: r, type: l, ctx: this.ctx, chart: this })).id] = h),
                h.init(n, t);
            }),
            (0, s.F)(a, (t, e) => {
              t || delete i[e];
        ...
        buildOrUpdateControllers() {
          ...
          for (this._removeUnreferencedMetasets(), t = 0, e = a.length; t < e; t++) {
            ...
            if (
              (n.type && n.type !== r && (this._destroyDatasetMeta(t), (n = this.getDatasetMeta(t))),
              (n.type = r),
              ...
              Object.assign(e, { dataElementType: tS.getElement(o), datasetElementType: a && tS.getElement(a) }),
        ...
        render() {
          !1 !== this.notifyPlugins("beforeRender", { cancelable: !0 }) &&
            (n.has(this) ? this.attached && !n.running(this) && n.start(this) : (this.draw(), tj({ chart: this })));
        }
        draw() {
          let t;
        ...
        _drawDataset(t) {
          let e = this.ctx,
            ...
            n = (function (t, e) {
              ...
              return i && s
                ? { left: tX(i, e, "left"), right: tX(i, e, "right"), top: tX(s, e, "top"), bottom: tX(s, e, "bottom") }
                : e;
            })(t, this.chartArea),
        ...
        _stop() {
          let t, e;
          for (this.stop(), n.remove(this), t = 0, e = this.data.datasets.length; t < e; ++t)
        ...
        updateHoverStyle(t, e, i) {
          ...
          let r = i ? "set" : "remove";
          for (
            "dataset" === e && this.getDatasetMeta(t[0].datasetIndex).controller["_" + r + "DatasetHoverStyle"](),
              a = 0,
              n = t.length;
            a < n;
            ++a
        ...
        _handleEvent(t, e, i) {
          ...
          let { _active: n = [], options: r } = this,
            ...
            l = (0, s.ai)(t),
            h = ((a = this._lastEvent), i && "mouseout" !== t.type ? (l ? a : t) : null);
          i &&
      ...
      function tJ(t, e, i, a, n, r) {
        ...
        if ((t.beginPath(), r)) {
          ...
          let a = (_ - k / g + (b + M / g)) / 2;
          if ((t.arc(o, l, g, _ - k / g, a, !0), t.arc(o, l, g, a, b + M / g, !0), M > 0)) {
            let e = tK(C, E, o, l);
            ...
            (function (t, e, i, a, n) {
              ...
              p &&
                (function (t, e, i) {
                  ...
                  t.beginPath(),
                    t.arc(r, o, l, a - d, i + d),
                    h > n ? ((d = n / h), t.arc(r, o, h, i + d, a - d, !0)) : t.arc(r, o, n, i + s.H, a - s.H),
                    t.closePath(),
                    t.clip();
                })(t, e, f),
      ...
      function t3(t, e, i, a) {
        ...
        let { points: l, options: h } = e,
          ...
          p = h.stepped ? s.ar : h.tension || "monotone" === h.cubicInterpolationMode ? s.as : t1,
          { move: f = !0, reverse: m } = a || {};
        for (n = 0; n <= g; ++n)
          (r = l[(c + (m ? g - n : n)) % d]).skip ||
            (f ? (t.moveTo(r.x, r.y), (f = !1)) : p(t, o, r, m, h.stepped), (o = r));
          ...
          (this.points || []).length &&
            ...
            (function (t, e, i, s) {
              if (t4 && !e.options.segment) {
                let a;
                (a = e._path) || ((a = e._path = new Path2D()), e.path(a, i, s) && a.closePath()),
                  t0(t, e.options),
                  t.stroke(a);
              } else
                !(function (t, e, i, s) {
      ...
      function et(t, e) {
        ...
        return (
          t.horizontal
            ? ((r = c / 2), (i = Math.min(o, h)), (s = Math.max(o, h)), (a = l - r), (n = l + r))
            : ((i = o - (r = d / 2)), (s = o + r), (a = Math.min(l, h)), (n = Math.max(l, h))),
      ...
      function ea(t, e, i = {}) {
        ...
        return { x: t.x + s, y: t.y + a, w: t.w + n, h: t.h + r, radius: t.radius };
      }
      class en extends tp {
        static id = "bar";
        static defaults = {
        ...
        draw(t) {
          ...
          let {
            ...
            l = (e = o.radius).topLeft || e.topRight || e.bottomLeft || e.bottomRight ? s.au : es;
          t.save(),
            (o.w !== r.w || o.h !== r.h) &&
              (t.beginPath(), l(t, ea(o, i, r)), t.clip(), l(t, ea(r, -i, o)), (t.fillStyle = a), t.fill("evenodd")),
            t.beginPath(),
            l(t, ea(r, i)),
            (t.fillStyle = n),
            t.fill(),
      ...
      function er(t, e, i, a) {
        ...
        let n = e[t],
          r = i[t];
        return "angle" === t && ((n = (0, s.ay)(n)), (r = (0, s.ay)(r))), { property: t, start: n, end: r };
      }
      function eo(t, e, i) {
        for (; e > t; e--) {
          let t = i[e];
      ...
      class eu extends tp {
          ...
          return (
            this.legendItems.forEach((t, n) => {
              ...
              let { itemWidth: b, itemHeight: _ } = {
                itemWidth:
                  ((m = t.text) && "string" != typeof m && (m = m.reduce((t, e) => (t.length > e.length ? t : e))),
                  i + e.size / 2 + a.measureText(m).width),
                itemHeight: ((f = e.lineHeight), (x = s), "string" != typeof t.text && (x = eg(t, f)), x),
              };
              n > 0 &&
                u + _ + 2 * r > h &&
                ((d += c + r), l.push({ width: c, height: u }), (g += c + r), p++, (c = u = 0)),
        ...
        adjustHitBoxes() {
          ...
          if (this.isHorizontal()) {
            ...
            for (let l of e)
              n !== l.row && ((n = l.row), (o = (0, s.a2)(i, this.left + a, this.right - this.lineWidths[n]))),
                (l.top += this.top + t + a),
            ...
            for (let l of e)
              l.col !== n &&
                ((n = l.col), (o = (0, s.a2)(i, this.top + t + a, this.bottom - this.columnSizes[n].height))),
                (l.top = o),
                (l.left += this.left + a),
        ...
        _draw() {
          ...
          let { boxWidth: p, boxHeight: f, itemHeight: m } = ed(o, u),
            ...
            b = function (t, e, i) {
              (0, s.Z)(n, i.text, t, e + m / 2, d, { strikethrough: i.hidden, textAlign: h.textAlign(i.textAlign) });
            },
            _ = this.isHorizontal(),
            v = this._computeTitleHeight();
          (t = _
            ? { x: (0, s.a2)(r, this.left + c, this.right - a[0]), y: this.top + c + v, line: 0 }
            : { x: this.left + c, y: (0, s.a2)(r, this.top + v + c, this.bottom - i[0].height), line: 0 }),
          ...
          this.legendItems.forEach((l, u) => {
            ...
            if (
              ...
              _
                ? u > 0 &&
                  k + M + c > this.right &&
                  ((w = t.y += y), t.line++, (k = t.x = (0, s.a2)(r, this.left + c, this.right - a[t.line])))
                : u > 0 &&
                  w + y > this.bottom &&
                  ((k = t.x = k + i[t.line].width + c),
                  t.line++,
                  (w = t.y = (0, s.a2)(r, this.top + v + c, this.bottom - i[t.line].height))),
              x(h.x(k), w, l),
              (k = (0, s.aB)(m, k + p + g, _ ? k + M : this.right, e.rtl)),
              b(h.x(k), w, l),
              _)
            )
              t.x += M + c;
        ...
        drawTitle() {
          ...
          let r = (0, s.az)(e.rtl, this.left, this.width),
            ...
            u = this.width;
          if (this.isHorizontal())
            (u = Math.max(...this.lineWidths)), (t = this.top + d), (c = (0, s.a2)(e.align, c, this.right - u));
          else {
        ...
        _getLegendItemAt(t, e) {
          ...
          if ((0, s.aj)(t, this.left, this.right) && (0, s.aj)(e, this.top, this.bottom)) {
            for (i = 0, n = this.legendHitBoxes; i < n.length; ++i)
              if (((a = n[i]), (0, s.aj)(t, a.left, a.left + a.width) && (0, s.aj)(e, a.top, a.top + a.height)))
        ...
        handleEvent(t) {
          ...
          let i = this.options;
          if (
            (("mousemove" !== (e = t.type) && "mouseout" !== e) || (!i.onHover && !i.onLeave)) &&
      ...
      let ef = {
        average(t) {
          ...
          return 0 !== n && 0 !== s.size && { x: [...s].reduce((t, e) => t + e) / s.size, y: a / n };
        },
        nearest(t, e) {
          let i, a, n;
          if (!t.length) return !1;
      ...
      function ev(t, e, i, a) {
        let { caretSize: n, caretPadding: r, cornerRadius: o } = t,
          { xAlign: l, yAlign: h } = i,
          d = n + r,
          { topLeft: c, topRight: u, bottomLeft: g, bottomRight: p } = (0, s.aw)(o),
          f = (function (t, e) {
            let { x: i, width: s } = t;
        ...
        return (
          ...
          { x: (0, s.S)(f, 0, a.width - e.width), y: (0, s.S)(m, 0, a.height - e.height) }
        );
      }
      function ey(t, e, i) {
      ...
      class eS extends tp {
        ...
        getTitle(t, e) {
          let { callbacks: i } = e,
            s = ew(i, "beforeTitle", this, t),
            a = ew(i, "title", this, t),
            n = ew(i, "afterTitle", this, t),
            r = [];
          return (r = em(r, ex(s))), (r = em(r, ex(a))), (r = em(r, ex(n)));
        }
        getBeforeBody(t, e) {
          return em([], ex(ew(e.callbacks, "beforeBody", this, t)));
        }
        getBody(t, e) {
          let { callbacks: i } = e,
            a = [];
          return (
            (0, s.F)(t, (t) => {
              let e = { before: [], lines: [], after: [] },
                s = eM(i, t);
              em(e.before, ex(ew(s, "beforeLabel", this, t))),
                em(e.lines, ew(s, "label", this, t)),
                em(e.after, ex(ew(s, "afterLabel", this, t))),
                a.push(e);
            }),
            a
          );
        ...
        getAfterBody(t, e) {
          return em([], ex(ew(e.callbacks, "afterBody", this, t)));
        }
        getFooter(t, e) {
          let { callbacks: i } = e,
            s = ew(i, "beforeFooter", this, t),
            a = ew(i, "footer", this, t),
            n = ew(i, "afterFooter", this, t),
            r = [];
          return (r = em(r, ex(s))), (r = em(r, ex(a))), (r = em(r, ex(n)));
        }
        _createItems(t) {
          ...
          return (
            ...
            (0, s.F)(h, (e) => {
              let i = eM(t.callbacks, e);
              r.push(ew(i, "labelColor", this, e)),
                o.push(ew(i, "labelPointStyle", this, e)),
                l.push(ew(i, "labelTextColor", this, e));
            }),
            (this.labelColors = r),
        ...
        update(t, e) {
          ...
          let s = this.options.setContext(this.getContext()),
            ...
            n = [];
          if (a.length) {
            let t = ef[s.position].call(this, a, this._eventPosition);
            ...
            let e = (this._size = eb(this, s)),
              r = Object.assign({}, t, e),
              o = e_(this.chart, s, r),
              l = ev(s, r, o, this.chart);
            (this.xAlign = o.xAlign),
              (this.yAlign = o.yAlign),
              (i = { opacity: 1, x: l.x, y: l.y, width: e.width, height: e.height, caretX: t.x, caretY: t.y });
        ...
        getCaretPosition(t, e, i) {
          ...
          let { xAlign: d, yAlign: c } = this,
            ...
            { topLeft: p, topRight: f, bottomLeft: m, bottomRight: x } = (0, s.aw)(g),
            { x: b, y: _ } = t,
            { width: v, height: y } = e;
          return (
            "center" === c
              ? ((l = _ + y / 2),
                ...
                (r = a))
              : ((n = "left" === d ? b + Math.max(p, m) + u : "right" === d ? b + v - Math.max(f, x) - u : this.caretX),
                "top" === c
                  ? ((l = (o = _) - u), (a = n - u), (r = n + u))
        ...
        _drawColorBox(t, e, i, a, n) {
          let r = this.labelColors[i],
            ...
            p = e.y + g;
          if (n.usePointStyle) {
            let e = { radius: Math.min(h, l) / 2, pointStyle: o.pointStyle, rotation: o.rotation, borderWidth: 1 },
            ...
            (t.lineWidth = (0, s.i)(r.borderWidth) ? Math.max(...Object.values(r.borderWidth)) : r.borderWidth || 1),
              (t.strokeStyle = r.borderColor),
        ...
        drawBody(t, e, i) {
          ...
          for (
            e.textAlign = g,
              ...
              v = p && "right" !== k ? ("center" === g ? m / 2 + x : m + 2 + x) : 0,
              o = 0,
              h = c.length;
            o < h;
            ++o
            ...
            for (
              a = c[o],
                ...
                (0, s.F)(a.before, M),
                r = a.lines,
                p && r.length && (this._drawColorBox(e, t, o, y, i), (_ = Math.max(b.lineHeight, f))),
                l = 0,
                d = r.length;
              l < d;
              ++l
        ...
        drawFooter(t, e, i) {
          ...
          if (o) {
            ...
            for (
              ...
              e.fillText(r[n], l.x(t.x), t.y + a.lineHeight / 2), (t.y += a.lineHeight + i.footerSpacing);
          }
        }
        drawBackground(t, e, i, a) {
          let { xAlign: n, yAlign: r } = this,
            { x: o, y: l } = t,
            { width: h, height: d } = i,
            { topLeft: c, topRight: u, bottomLeft: g, bottomRight: p } = (0, s.aw)(a.cornerRadius);
        ...
        _updateAnimationTarget(t) {
          let e = this.chart,
            ...
            a = i && i.y;
          if (s || a) {
            let i = ef[t.position].call(this, this._active, this._eventPosition);
            if (!i) return;
            let n = (this._size = eb(this, t)),
        ...
        handleEvent(t, e, i = !0) {
          ...
          return (
            l &&
              ((this._active = r),
              (a.enabled || a.external) && ((this._eventPosition = { x: t.x, y: t.y }), this.update(!0, e))),
            l
          );
        }
        _getActiveElements(t, e, i, s) {
      ...
      var eD = {
        ...
        positioners: ef,
        afterInit(t, e, i) {
          i && (t.tooltip = new eS({ chart: t, options: i }));
        },
        beforeUpdate(t, e, i) {
      ...
      let eP = (t, e, i, s) => (
        ...
        eC = (t, e) => (null === t ? null : (0, s.S)(Math.round(t), 0, e));
      function eL(t) {
      ...
      class eE extends tM {
        static id = "category";
        static defaults = { ticks: { callback: eL } };
        constructor(t) {
          ...
          return eC(
            (e =
              isFinite(e) && i[e] === t
                ...
                : (function (t, e, i, s) {
                    let a = t.indexOf(e);
                    return -1 === a ? eP(t, e, i, s) : a !== t.lastIndexOf(e) ? i : a;
      ...
      function eO(t, e, { horizontal: i, minRotation: a }) {
        let n = (0, s.t)(a),
          r = 0.75 * e * ("" + t).length;
      ...
      class eA extends tM {
        ...
        getTickLimit() {
          ...
          return (
            i
              ? (t = Math.ceil(this.max / i) - Math.floor(this.min / i) + 1) > 1e3 &&
                (console.warn(
        ...
        buildTicks() {
          let t = this.options,
            ...
            a = (function (t, e) {
              ...
              (r = Math.ceil(v / S) - Math.floor(_ / S)) > b && (S = (0, s.aH)((r * S) / b / x) * x),
                (0, s.k)(u) || (S = Math.ceil(S * (i = Math.pow(10, u))) / i),
                "ticks" === l ? ((a = Math.floor(_ / S) * S), (n = Math.ceil(v / S) * S)) : ((a = _), (n = v)),
                y && M && h && (0, s.aI)((c - d) / h, S / 1e3)
                  ? ((r = Math.round(Math.min((c - d) / S, p))), (S = (c - d) / r), (a = d), (n = c))
                  : k
                    ? ((a = y ? d : a), (S = ((n = M ? c : n) - a) / (r = g - 1)))
                    : ((r = (n - a) / S), (r = (0, s.aJ)(r, Math.round(r), S / 1e3) ? Math.round(r) : Math.ceil(r)));
              ...
              for (
                ...
                (m && a !== d
                  ? (o.push({ value: d }),
                    a < d && P++,
                    (0, s.aJ)(Math.round((a + P * S) * i) / i, d, eO(d, w, t)) && P++)
                  : a < d && P++);
                P < r;
                ++P
              ) {
              ...
              return (
                M && m && n !== c
                  ? o.length && (0, s.aJ)(o[o.length - 1].value, c, eO(c, w, t))
      ...
      class eT extends eA {
        ...
        computeTickLimit() {
          ...
          return Math.ceil(
            e / Math.min(40, this._resolveTickFontOptions(0).lineHeight / ((t ? Math.sin(i) : Math.cos(i)) || 0.001)),
          );
        }
        getPixelForValue(t) {
      ...
      let eF = (t) => Math.floor((0, s.aM)(t)),
        ez = (t, e) => Math.pow(10, eF(t) + e);
      function eR(t) {
        return 1 == t / Math.pow(10, eF(t));
      }
      function eI(t, e, i) {
        let s = Math.pow(10, i);
      ...
      class eV extends tM {
        ...
        static defaults = { ticks: { callback: s.aL.formatters.logarithmic, major: { enabled: !0 } } };
        constructor(t) {
          super(t), (this.start = void 0), (this.end = void 0), (this._startValue = void 0), (this._valueRange = 0);
        }
        parse(t, e) {
          let i = eA.prototype.parse.apply(this, [t, e]);
          if (0 === i) {
            this._zero = !0;
            return;
          }
        ...
        determineDataLimits() {
          ...
          (this.min = (0, s.g)(t) ? Math.max(0, t) : null),
            ...
            this._zero &&
              ...
              !(0, s.g)(this._userMin) &&
              (this.min = t === ez(this.min, 0) ? ez(this.min, -1) : ez(this.min, 0)),
        ...
        handleTickRangeOptions() {
          let { minDefined: t, maxDefined: e } = this.getUserBounds(),
            ...
            a = (e) => (i = t ? i : e),
            n = (t) => (s = e ? s : t);
          i === s && (i <= 0 ? (a(1), n(10)) : (a(ez(i, -1)), n(ez(s, 1)))),
            i <= 0 && a(ez(s, -1)),
            s <= 0 && n(ez(i, 1)),
            (this.min = i),
            (this.max = s);
        ...
        buildTicks() {
          let t = this.options,
            e = (function (t, { min: e, max: i }) {
              ...
              for (; g < i; )
                a.push({ value: g, major: eR(g), significand: u }),
                  u >= 10 ? (u = u < 15 ? 15 : 20) : u++,
                  u >= 20 && ((u = 2), (o = ++r >= 0 ? 1 : o)),
                  (g = Math.round((h + c + u * Math.pow(10, r)) * o) / o);
              let p = (0, s.O)(t.max, g);
              return a.push({ value: p, major: eR(p), significand: u }), a;
        ...
        getPixelForValue(t) {
          return ((void 0 === t || 0 === t) && (t = this.min), null === t || isNaN(t))
            ? NaN
            : this.getPixelForDecimal(t === this.min ? 0 : ((0, s.aM)(t) - this._startValue) / this._valueRange);
        }
        getValueForPixel(t) {
      ...
      class eW extends eA {
        ...
        generateTickLabels(t) {
          eA.prototype.generateTickLabels.call(this, t),
                ...
                for (let c = 0; c < r; c++) {
                  ...
                  let u = t.getPointPosition(c, t.drawingArea + n[c], l),
                    ...
                    p =
                      ...
                      (d = t._pointLabels[c]),
                      (d = (0, s.b)(d) ? d : [d]),
                      { w: (0, s.aN)(h, g.string, d), h: d.length * g.lineHeight });
                  a[c] = p;
                  ...
                  !(function (t, e, i, s, a) {
                    ...
                    s.start < e.l
                      ...
                      : s.end > e.r && ((o = (s.end - e.r) / n), (t.r = Math.max(t.r, e.r + o))),
                      a.start < e.t
                        ? ((l = (e.t - a.start) / r), (t.t = Math.min(t.t, e.t - l)))
                        : a.end > e.b && ((l = (a.end - e.b) / r), (t.b = Math.max(t.b, e.b + l)));
                  })(i, e, f, eB(m, u.x, p.w, 0, 180), eB(m, u.y, p.h, 90, 270));
                }
                t.setCenterPoint(e.l - i.l, i.r - e.r, e.t - i.t, i.b - e.b),
                  (t._pointLabelItems = (function (t, e, i) {
                    ...
                    let n = [],
                      ...
                      d = { extra: eN(o) / 2, additionalAngle: l ? s.P / r : 0 };
                    for (let o = 0; o < r; o++) {
        ...
        getPointLabelContext(t) {
          ...
          if (t >= 0 && t < e.length) {
            var i;
            let a = e[t];
            return (i = this.getContext()), (0, s.j)(i, { label: a, index: t, type: "pointLabel" });
          }
        }
        getPointPosition(t, e, i = 0) {
          let a = this.getIndexAngle(t) - s.H + i;
          return { x: Math.cos(a) * e + this.xCenter, y: Math.sin(a) * e + this.yCenter, angle: a };
        }
        ...
        drawBackground() {
          ...
          if (t) {
            ...
            i.save(),
              i.beginPath(),
              eH(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length),
              i.closePath(),
              (i.fillStyle = t),
              i.fill(),
              i.restore();
          ...
          if (
                  ...
                  !(function (t, e, i) {
                    ...
                    if (!(0, s.k)(l)) {
                      ...
                      Object.values(i).some((t) => 0 !== t)
                        ? (t.beginPath(), (0, s.au)(t, { x: d, y: c, w: u, h: g, radius: i }), t.fill())
                        : t.fillRect(d, c, u, g);
                    }
                  })(i, r, e);
                  let o = (0, s.a0)(r.font),
            ...
            for (a.save(), t = h - 1; t >= 0; t--) {
              ...
              l &&
                ...
                (e = this.getDistanceFromCenterForValue(n.reverse ? this.min : this.max)),
      ...
      function eY(t, e) {
        ...
        null === o)
          ? null
          : (n && (o = "week" === n && ((0, s.x)(r) || !0 === r) ? i.startOf(o, "isoWeek", r) : i.startOf(o, n)), +o);
      }
      function eQ(t, e, i, s) {
        let a = e$.length;
        for (let n = e$.indexOf(t); n < a - 1; ++n) {
          let t = ej[e$[n]],
            a = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
          if (t.common && Math.ceil((i - e) / (a * t.size)) <= s) return e$[n];
        }
        return e$[a - 1];
      }
      function eX(t, e, i) {
      ...
      function eq(t, e, i) {
        ...
        let n = [],
          r = {},
          o = e.length;
        for (s = 0; s < o; ++s) (r[(a = e[s])] = s), n.push({ value: a, major: !1 });
        return 0 !== o && i
          ? (function (t, e, i, s) {
              let a, n;
              let r = t._adapter,
      ...
      class eG extends tM {
        ...
        parse(t, e) {
          return void 0 === t ? null : eY(this, t);
        }
        beforeLayout() {
          ...
          return (
            (this._unit =
              ...
              (i.autoSkip
                ...
                : (function (t, e, i, s, a) {
                    for (let n = e$.length - 1; n >= e$.indexOf(i); n--) {
                      let i = e$[n];
                      if (ej[i].common && t._adapter.diff(a, s, i) >= e - 1) return i;
                    }
            ...
            (this._majorUnit =
              i.major.enabled && "year" !== this._unit
                ? (function (t) {
                    for (let e = e$.indexOf(t) + 1, i = e$.length; e < i; ++e) if (ej[e$[e]].common) return e$[e];
                  })(this._unit)
                : void 0),
            this.initOffsets(a),
            t.reverse && o.reverse(),
            eq(this, o, this._majorUnit)
          );
        }
        afterAutoSkip() {
        ...
        _generate() {
          ...
          let i = this._adapter,
            ...
            u = {},
            g = a;
          if ((c && (g = +i.startOf(g, "isoWeek", d)), (g = +i.startOf(g, c ? "day" : l)), i.diff(n, a, l) > 1e5 * h))
            throw Error(a + " and " + n + " are too far apart with stepSize of " + h + " " + l);
          let p = "data" === r.ticks.source && this.getDataTimestamps();
          for (t = g, e = 0; t < n; t = +i.add(t, h, l), e++) eX(u, t, p);
          return (
            (t === n || "ticks" === r.bounds || 1 === e) && eX(u, t, p),
            Object.keys(u)
              .sort(eU)
              .map((t) => +t)
          );
        ...
        _getLabelCapacity(t) {
          let e = this.options.time,
            ...
            a = this._tickFormatFunction(t, 0, eq(this, [t], this._majorUnit), s),
        ...
        getLabelTimestamps() {
          ...
          for (t = 0, e = s.length; t < e; ++t) i.push(eY(this, s[t]));
          return (this._cache.labels = this._normalized ? i : this.normalize(i));
        }
        normalize(t) {
          return (0, s._)(t.sort(eU));
        }
      }
      function eK(t, e, i) {
        let a,
          ...
          h = t.length - 1;
        i
          ? (e >= t[l].pos && e <= t[h].pos && ({ lo: l, hi: h } = (0, s.B)(t, "pos", e)),
            ({ pos: a, time: r } = t[l]),
            ({ pos: n, time: o } = t[h]))
          : (e >= t[l].time && e <= t[h].time && ({ lo: l, hi: h } = (0, s.B)(t, "time", e)),
            ({ time: a, pos: r } = t[l]),
            ({ time: n, pos: o } = t[h]));
        let d = n - a;
      ...
      class eJ extends eG {
        ...
        initOffsets() {
          ...
          (this._minPos = eK(e, this.min)), (this._tableRange = eK(e, this.max) - this._minPos), super.initOffsets(t);
        }
        buildLookupTable(t) {
          let e, i, s;
          ...
          for (e = 0, i = r.length; e < i; ++e)
            Math.round((r[e + 1] + r[e - 1]) / 2) !== (s = r[e]) && o.push({ time: s, pos: e / (i - 1) });
          return o;
        }
        _generate() {
          let t = this.min,
        ...
        getDecimalForValue(t) {
          return (eK(this._table, t) - this._minPos) / this._tableRange;
        }
        getValueForPixel(t) {
          let e = this._offsets,
            i = this.getDecimalForPixel(t) / e.factor - e.end;
          return eK(this._table, i * this._tableRange + this._minPos, !0);
        }
      }
    },
  },
