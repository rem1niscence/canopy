...
type Message struct {
	...
	Evidence  []*types.DoubleSignEvidence `protobuf:"bytes,5,rep,name=evidence,proto3" json:"evidence,omitempty"`
	Signature *types.Signature            `protobuf:"bytes,6,opt,name=signature,proto3" json:"signature,omitempty"`
}
...
func (x *Message) GetEvidence() []*types.DoubleSignEvidence {
	if x != nil {
		return x.Evidence
	}
	return nil
...
var file_consensus_proto_rawDesc = []byte{
	...
	0x96, 0x02, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x23, 0x0a, 0x06, 0x68,
	...
	0x63, 0x12, 0x35, 0x0a, 0x08, 0x65, 0x76, 0x69, 0x64, 0x65, 0x6e, 0x63, 0x65, 0x18, 0x05, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x44, 0x6f, 0x75, 0x62,
	0x6c, 0x65, 0x53, 0x69, 0x67, 0x6e, 0x45, 0x76, 0x69, 0x64, 0x65, 0x6e, 0x63, 0x65, 0x52, 0x08,
	0x65, 0x76, 0x69, 0x64, 0x65, 0x6e, 0x63, 0x65, 0x12, 0x2e, 0x0a, 0x09, 0x73, 0x69, 0x67, 0x6e,
	0x61, 0x74, 0x75, 0x72, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x74, 0x79,
	...
	0x67, 0x69, 0x6e, 0x63, 0x68, 0x75, 0x2f, 0x63, 0x6f, 0x6e, 0x73, 0x65, 0x6e, 0x73, 0x75, 0x73,
...
var file_consensus_proto_depIdxs = []int32{
	...
	4, // 4: types.Message.evidence:type_name -> types.DoubleSignEvidence
	2, // 5: types.Message.signature:type_name -> types.Signature
