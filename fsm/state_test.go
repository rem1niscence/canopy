	...
	tests := []struct {
		...
		},
		{
			...
			expectedHeader: &lib.BlockHeader{
				Height: 3,
				Hash: []byte{
					0x55, 0xa1, 0x5e, 0xf2, 0x7a, 0x65, 0xce, 0xe6, 0x8, 0xe3, 0x52, 0x37, 0xe8, 0x57, 0x8b, 0x6, 0x51, 0x66, 0x7e, 0x9a, 0x6a, 0xbb, 0xd3, 0xc8, 0x12, 0x77, 0x12, 0x5d, 0x2d, 0x22, 0x79, 0x22,
				},
				Time:               timestamp,
				NumTxs:             1,
				TotalTxs:           1,
				...
				StateRoot:          []byte{0x88, 0x65, 0x7d, 0x45, 0x3c, 0xf7, 0x9e, 0x88, 0x9b, 0xe0, 0xcc, 0xf5, 0x9, 0xcc, 0xbd, 0x6f, 0x2e, 0x1f, 0xd7, 0xe9},
