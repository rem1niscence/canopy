	...
	tests := []struct {
		...
		},
		{
			...
			expectedHeader: &lib.BlockHeader{
				Height: 3,
				Hash: []byte{
					0x9d, 0xf, 0xb2, 0xd1, 0x4a, 0x50, 0xd8, 0xb7, 0xbb, 0x56, 0x7f, 0x7f, 0x72, 0x36, 0x45, 0xf9, 0xb, 0x5, 0xd0, 0x4b, 0x84, 0xab, 0x90, 0x4b, 0x9f, 0x69, 0x71, 0xc2, 0xd4, 0xa, 0x2, 0x2e,
				},
				Time:               timestamp,
				NumTxs:             1,
				TotalTxs:           1,
				...
				StateRoot:          []byte{0x91, 0x99, 0xd, 0xb3, 0x30, 0xde, 0xa6, 0xc8, 0x34, 0x11, 0xec, 0x75, 0xf2, 0x83, 0x17, 0x2b, 0xf5, 0x8, 0xa9, 0xd0},
