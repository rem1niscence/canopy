	...
	tests := []struct {
		...
		},
		{
			...
			expectedHeader: &lib.BlockHeader{
				Height: 3,
				Hash: []byte{
					0xe9, 0x4d, 0x3, 0xfd, 0x6c, 0xfd, 0xf, 0xa9, 0x6f, 0xf8, 0x28, 0xab, 0xc0, 0x40, 0x2, 0x29, 0xb, 0x17, 0xa5, 0x95, 0x25, 0x3e, 0x49, 0x15, 0x13, 0xc2, 0x3d, 0x17, 0x87, 0xed, 0x3d, 0x6,
				},
				Time:               timestamp,
				NumTxs:             1,
				TotalTxs:           1,
				...
				StateRoot:          []byte{0xb2, 0xbb, 0x3f, 0x5b, 0x8b, 0x79, 0x20, 0x9b, 0xef, 0xcc, 0x3a, 0x7e, 0x74, 0x5, 0x4b, 0xb7, 0x6, 0xe8, 0xe2, 0x9b},
