...
func TestApplyBlock(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedHeader: &lib.BlockHeader{
				Height:             3,
				Hash:               []byte{0x25, 0x47, 0xfa, 0xed, 0xb5, 0x79, 0x8b, 0xa8, 0x79, 0x18, 0xb0, 0x63, 0xa7, 0x3a, 0xcc, 0xb, 0x74, 0x8e, 0xd2, 0xf9, 0xc3, 0x63, 0x18, 0xf5, 0x37, 0xbc, 0xde, 0xdb, 0xe4, 0xd1, 0xd3, 0x83},
				NetworkId:          1,
				Time:               timestamp,
				NumTxs:             1,
				TotalTxs:           1,
				...
				StateRoot:          []byte{0xaf, 0x9e, 0xe9, 0xf1, 0xe0, 0x2d, 0x12, 0xd6, 0x83, 0x7b, 0x10, 0x69, 0x80, 0x96, 0xaa, 0x15, 0x39, 0x64, 0xef, 0x4e},
