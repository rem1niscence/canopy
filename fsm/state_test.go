...
func TestApplyBlock(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedHeader: &lib.BlockHeader{
				Height:             3,
				Hash:               []byte{0xfa, 0xa, 0xa7, 0xc9, 0xfa, 0x40, 0xd5, 0x24, 0x74, 0xa9, 0x77, 0xf, 0x28, 0x8c, 0x7, 0x7b, 0x7b, 0x4b, 0x37, 0xd2, 0x3d, 0x29, 0xf2, 0x3, 0xfa, 0xd4, 0x30, 0x98, 0xd7, 0xf6, 0x5e, 0x12},
				NetworkId:          1,
				Time:               timestamp,
				NumTxs:             1,
				TotalTxs:           1,
				...
				StateRoot:          []byte{0xea, 0xf1, 0x73, 0x4f, 0xf6, 0xbe, 0xfb, 0xc, 0x12, 0x9d, 0x23, 0x1a, 0x11, 0x8d, 0x37, 0xc3, 0x5f, 0xf0, 0x26, 0x7f},
