	...
	tests := []struct {
		...
		},
		{
			...
			expectedHeader: &lib.BlockHeader{
				Height: 3,
				Hash: []byte{
					0x1d, 0x78, 0xbc, 0xd, 0x4d, 0xbc, 0xab, 0xe9, 0x2d, 0x62, 0x58, 0x98, 0x72, 0xfb, 0x4d, 0x5a, 0xf2, 0xc5, 0x18, 0xc4, 0x36, 0xbc, 0xe7, 0xed, 0xc1, 0x57, 0x28, 0xdd, 0x77, 0xff, 0xe0, 0xfb,
				},
				Time:               timestamp,
				NumTxs:             1,
				TotalTxs:           1,
