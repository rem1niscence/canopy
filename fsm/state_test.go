	...
	tests := []struct {
		...
		},
		{
			...
			expectedHeader: &lib.BlockHeader{
				Height: 3,
				Hash: []byte{
					0xc6, 0x8d, 0x1c, 0x1b, 0x7c, 0xc5, 0x76, 0x44, 0x40, 0x36, 0x9, 0x2e, 0x3, 0x8d, 0x2a, 0xca, 0x59, 0x7d, 0xbf, 0x3b, 0x13, 0x6a, 0x9c, 0x3a, 0x81, 0x3, 0xe8, 0xc, 0x29, 0xd, 0x10, 0x5,
				},
				Time:               timestamp,
				NumTxs:             1,
				TotalTxs:           1,
				...
				StateRoot:          []byte{0xb6, 0x57, 0x16, 0x56, 0x1b, 0xef, 0x8f, 0xc3, 0xaf, 0x0, 0x17, 0xc6, 0x94, 0x2f, 0x98, 0xd, 0xac, 0x50, 0x94, 0x2},
