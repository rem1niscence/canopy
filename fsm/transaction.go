...
func (s *StateMachine) ApplyTransaction(index uint64, transaction []byte, txHashBz []byte, txHash string, batchVerifier *crypto.BatchVerifier) (*lib.TxResult, lib.ErrorI) {
